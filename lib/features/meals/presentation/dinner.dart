...
import '../data/dinner_provider.dart';
...
class _DinnerState extends ConsumerState<Dinner> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.refresh(dinnerProvider));
  ...
  Widget build(BuildContext context) {
    ...
    final dinnerAsync = ref.watch(dinnerProvider);
      ...
      body: Column(
        children: [
          ...
          if (_isSearching)
            ...
            Expanded(
              child: Center(
                child: dinnerAsync.when(
                  data: (entries) {
                    if (entries.isEmpty) return const Center(child: Text("No dinner items"));
