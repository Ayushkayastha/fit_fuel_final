...
import '../data/afternoon_snack_provider.dart';
...
class _AfternoonSnackState extends ConsumerState<AfternoonSnack> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.refresh(afternoonSnackProvider));
  ...
  Widget build(BuildContext context) {
    ...
    final afternoonSnackAsync = ref.watch(afternoonSnackProvider);
      ...
      body: Column(
        children: [
          ...
          if (_isSearching)
            ...
            Expanded(
              child: Center(
                child: afternoonSnackAsync.when(
                  data: (entries) {
                    if (entries.isEmpty) return const Center(child: Text("No afternoonSnack items"));
