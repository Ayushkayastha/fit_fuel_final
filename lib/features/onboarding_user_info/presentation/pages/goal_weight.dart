...
class GoalWeight extends ConsumerWidget {
  const GoalWeight({super.key});

  @override
  Widget build(BuildContext context,WidgetRef ref) {
    final selected = ref.watch(goalWeightUnitSelectionProvider);//yesma kun select gareko aaucha cm ft or inch
    final notifier = ref.read(goalWeightUnitSelectionProvider.notifier);
